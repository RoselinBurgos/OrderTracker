...
<body style ="background: url('/completededit.jpg')no-repeat center center fixed;  background-size: cover;">
...
<form:form method="POST" action="/jobs/edit/${id}" modelAttribute="job">
    ...
    <form:label path="date_placed" cssClass = "h5 ml-5 mt-5"><p class="text-black font-weight-bold">Order Date:</p>
        ...
        <form:input path="date_placed"  type="date" cssClass="form-control ml-3 border border-secondary"/>
    </form:label>
    ...
    <form:label path="due_date" cssClass = "h5 ml-5 mt-5"><p class="text-black font-weight-bold">Due Date:</p>
        ...
        <form:input path="due_date"  type="date" cssClass="form-control ml-3 border border-secondary"/>
    </form:label>
 	<br>
	...
	<br>
    <form:label path="completedStatus"><p p class="h5 text-white font-weight-bold ml-5">Reopen Order?</p></form:label>
    <form:select path="completedStatus" cssClass = "h5 ml-5 mt-5">
    	<form:option value="true"> No</form:option>
    	<form:option value="false">Yes</form:option>
    </form:select>


    <button input type="submit" value="Submit" class="btn btn-secondary ml-5 d-block">Edit Order</button>
</form:form>
